...
# kuuta write ur back end code for chatbot
# and in home.js.. connect the chatbot with const res = await fetch("http://localhost:5000/chat" cuz uk
# its where we routed the backed 
# and remove the # of app.register_blueprint(chatbot_bp)    in app.py
