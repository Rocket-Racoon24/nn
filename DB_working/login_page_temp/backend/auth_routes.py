...
def home_data():
    ...
    # Get user's existing data
    user_data = DatabaseOperations.get_user_data(user_email)
...
def logout():
    ...
    DatabaseOperations.deactivate_session(user_email)
    
    return jsonify({
        'message': 'Logout successful'
    }), 200

# Get user data (for refreshing data without full login)
